...
# Versão: 9.9.2 (Unified Edition)
# "O retorno do Disclaimer completo + Novas Lógicas de Divergência."
# ==============================================

# --- CONFIGURAÇÕES GERAIS ---
SCRIPT_VERSION="9.9.2"
...
CONSISTENCY_CHECKS=3          # Quantas vezes perguntar?
